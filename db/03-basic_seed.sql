INSERT INTO nfl_team (`full`, `name`, `short`) VALUES
('National Football League', 'NFL', 'NFL'),
('American Football Conference', 'AFC', 'AFC'),
('National Football Conference', 'NFC', 'NFC'),
...
('Washington Football Team', 'Washington', 'WAS');
